...
module.exports = function () {
    ...
    browser.visit(rmConfig.internLoginUrl, function () {
        console.log("Login Page loaded: ", browser.location.href);
        browser.fill("input#student_username_rollnumber", rmConfig.internUsername);
        browser.fill("input#student_password", rmConfig.internPassword);
        browser.document.forms[0].submit();

        browser.wait().then(function () {
            console.log("Form submitted OK! Now at: ", browser.location.href);
            browser.visit(rmConfig.internJobsUrl, function () {
